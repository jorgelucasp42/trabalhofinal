...
public class ConsultarHistoricoProntuarioServiceTest {
    ...
    void deveConsultarHistoricoVazio() {
        ...
        assertTrue(resultado.isEmpty(), "Histórico deve estar vazio para paciente inexistente");
    }
    ...
    void deveConsultarHistoricoComProntuarios() {
        ...
        // Assert
        assertNotNull(resultado);
        assertEquals(2, resultado.size(), "Deve retornar 2 prontuários do paciente");
        assertTrue(resultado.contains(prontuario1), "Deve conter prontuário 1");
        assertTrue(resultado.contains(prontuario2), "Deve conter prontuário 2");
    }
    ...
    void deveRetornarOrdenadoPorData() {
        ...
        assertEquals(p1.getId(), resultado.get(2).getId(), "Terceiro deve ser março");
    }
    ...
    void deveRetornarApenasDoMesmoPaciente() {
        ...
        Endereco endereco = new Endereco("Rua A", "1", null, "Centro", "São Luís", "MA", "65000-000");
        Paciente paciente1 = new Paciente(1, "João", "Pai", LocalDate.of(2019, 1, 1), "M",
                endereco, List.of(new Telefone("9800000000", TelefoneTipo.CELULAR, "Pai")), null);
        Paciente paciente2 = new Paciente(2, "Maria", "Mãe", LocalDate.of(2020, 5, 3), "F",
                endereco, List.of(new Telefone("9800000001", TelefoneTipo.CELULAR, "Mãe")), null);
        ...
        // Assert
        assertEquals(1, resultado.size(), "Deve retornar apenas 1 prontuário do paciente 1");
